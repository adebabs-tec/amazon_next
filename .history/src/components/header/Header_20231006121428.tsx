    ...
    <>
      <div className="w-full h-20 bg-amazon_blue text-lightText sticky top-0 z-50">
        <div className="h-full w-full inline-flex items-center justify-between gap-1 mdl:gap-3 px-4">
          ...
          {/* signin */}
          {userInfo ? (
            <div className="text-xs text-gray-100 px-2 border border-transparent hover:border-white cursor-pointer duration-300 flex items-center justify-center h-[70%]">
              <img
                src={userInfo.image}
                alt="userImage"
